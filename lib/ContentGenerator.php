    ...
    public function generateSection($type, $section, $materia, $unidad, $titulo, $referencias = [], $guiaContent = []) {
        ...
        $prompts = [
            'guia' => [
                ...
                'procedimiento' => "{$ctx}\n\nProcedimiento con este formato:\nDuración: X horas\n\nActividad 1. [Nombre] (min)\nPaso 1: [acción]\nPaso 2: [acción]\nPaso 3: [acción]\n\nActividad 2. [Nombre] (min)\nPaso 1: [acción]\nPaso 2: [acción]\n...\n\n(4-5 actividades, cada una con 2-4 pasos numerados. Incluye un ejercicio guiado breve)\n\n5.1 Materiales y equipos\nObligatorios: Laboratorio, Internet, Proyector, Pizarra, Marcadores, E-books.\nAdicionales: [solo los específicos para \"$titulo\"]",
